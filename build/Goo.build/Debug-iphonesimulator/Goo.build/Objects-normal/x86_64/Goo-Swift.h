...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Goo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC3Goo11AppDelegate")
...
SWIFT_CLASS("_TtC3Goo19FirtsViewController")
@interface FirtsViewController : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC3Goo8HomeView")
@interface HomeView : UITabBarController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC3Goo13SceneDelegate")
...
SWIFT_CLASS("_TtC3Goo20SecondViewController")
...
SWIFT_CLASS("_TtC3Goo18ShowsTableViewCell")
...
SWIFT_CLASS("_TtC3Goo11TvShowsView")
@interface TvShowsView : UIViewController <UITableViewDataSource, UITableViewDelegate>
- (void)viewDidLoad;
